...
## Note: Original repo is located here : https://github.com/Jerenaux/phaserquest
Thanks to Jerome for publishing this application.

I've modified slightly the server.js file to cater for deployment to different IaaS and PaaS scenarios both OpenStack (Fujitsu K5) and Cloud Foundry.

Will probably insert title stages etc. for demonstration purposes. I'm not adding any value to the game whatsoever - I'm simply using this as an example application for various infrastructure deployment models...I'm fed up showing wordpress deployments!

You can find my blog here: https://allthingscloud.eu
